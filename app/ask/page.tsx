...
export default async function AskPage({ searchParams }: Props) {
  ...
  return (
    <main className="action-page teacher-page">
      ...
      <div className="teacher-mode-list" role="tablist" aria-label="Bible teacher sections">
      ...
      <section className="teacher-dossier">
        ...
        <div className="teacher-card teacher-question"><p className="eyebrow">ASK THE TEACHER</p><h2>Study this passage with AI</h2><p>Choose a guided mode for a focused lesson, or ask your own question. The Teacher answers from this passage and its loaded Bible context.</p><TeacherChat reference={reference} /></div>
      </section>
